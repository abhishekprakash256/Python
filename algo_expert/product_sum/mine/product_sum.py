...
lst_3 = [5,2,[7,-1],3,[6,[-13,8],4]] #not passed
out = 12
#getting 42


def sum_product(array , mul = 1 , sum = 0 ):
	...
	for i in range(len(array)):
		...
		if type(array[i]) == list:
			...
			running_sum += sum_product(array = array[i] , mul = mul_, sum = running_sum)
